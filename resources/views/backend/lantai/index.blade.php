...
<div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('lantai.create') }}" class="btn btn-primary btn-sm">
    ...
    $(document).on('click', '.delete-btn', function() {
        var lantaiId = $(this).data('id');
        var url = '{{ route('lantai.destroy', ':id') }}';
        url = url.replace(':id', lantaiId); // Replace :id with the actual ID
