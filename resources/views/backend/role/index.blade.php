...
<div class="content-wrapper">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-xs btn-primary" href="{{ route('role.edit', $role->id) }}">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <button class="btn btn-xs btn-danger delete-btn" data-id="{{ $role->id }}">
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        url = url.replace(':id', roleId); // Replace :id with the actual ID
